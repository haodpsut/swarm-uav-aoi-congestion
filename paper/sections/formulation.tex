...
The main symbols are summarised in Table~\ref{tab:notation}.
...
\begin{align}
  \text{(P0)}\quad
  \argmin_{\mathbf{x},\,\mathbf{c},\,\{\mathbf{q}_m\},\,\{a_m\}}\ \
    & \bar{A}=\max_{k\in\mathcal{K}}\ \limsup_{t\to\infty}\ \Aoi_k(t)
    \label{eq:P0obj}\\
  \text{s.t.}\quad
...
fixed point, capacity allocation, assignment, and outer placement) detailed in
