...
the worst case at $M=8$. The heuristic is therefore essentially lossless in the
regime where an exact comparison is tractable, which supports its use at the
