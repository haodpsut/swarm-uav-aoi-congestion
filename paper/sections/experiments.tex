...
AoI stays controlled as the swarm grows, because the sensors and the charging
capacity scale together, and that the proposed contention-aware placement keeps
its advantage over the single pooled station and the coverage-optimal placement
across the whole range. The design therefore applies to genuine swarms, not only
to small fleets.
...
the collection radius ($11.3$ to $12.1\%$ for $r_c$ from $100$ to $400$~m) and
the charge time ($9.2$ to $13.6\%$). It is also larger, not smaller, on a
non-uniform field: when the sensors form clusters the gain rises to $19.2\%$,
