...
placement. A naive queueing model is misleading here: the charging
...
we also identify the regime in which a single pooled
station is already competitive. We further show that the greedy solver is within
